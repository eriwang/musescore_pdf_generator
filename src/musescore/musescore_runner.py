...
class MuseScore:
    ...
    def convert_to_pdf(self, src_filepath, out_filename):
        ...
        with scoped_named_temporary_file(content=MuseScore._create_style_file_text(), suffix='.mss') as style_filepath:
    ...
    def _create_style_file_text():
        ...
        style_node.extend([
            ...
            # create_node_with_text('Spatium', '2'),
        ])

        print(ET.tostring(style_file_root).decode('UTF-8'))
